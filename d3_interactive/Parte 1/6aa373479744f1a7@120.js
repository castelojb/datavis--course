// https://observablehq.com/@castelojb/taxa-de-desemprego-nos-eua-em-agosto-de-2016-parte-2@120
...
d3.tsv("https://gist.githubusercontent.com/emanueles/7fbdcd8ee412e3e63904114cf9d7ee3a/raw/af4fd93db1be3f9033caff46d4a574a54bf9363f/unemployment.tsv").then(function (data) {
  ...
  main.variable(observer()).define(["nomes"], function(nomes){return(
nomes.get('$01001')
)});
  main.variable(observer()).define(["rateById"], function(rateById){return(
rateById.get('$01001')
)});
...
d3.json("https://gist.githubusercontent.com/emanueles/ee2997bc6237f3dcab952ae8becaf6bf/raw/afdb12d4ef89bb239998b295c94d960e8d89c19e/us.json")
  ...
  main.variable(observer("nomes")).define("nomes", ["d3"], function(d3){return(
...
line-height: 20px;
  ...
  main.variable(observer("showTooltip")).define("showTooltip", ["d3","rateById","nomes"], function(d3,rateById,nomes){return(
